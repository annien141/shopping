...
<head>
    ...
    <!--[if lt IE 9]>
    <script type="text/javascript" src="/shopping/public/static/admin_index/lib/html5.js"></script>
    <script type="text/javascript" src="/shopping/public/static/admin_index/lib/respond.min.js"></script>
    <![endif]-->
    <link rel="stylesheet" type="text/css" href="/shopping/public/static/admin_index/static/h-ui/css/H-ui.min.css" />
    <link rel="stylesheet" type="text/css" href="/shopping/public/static/admin_index/static/h-ui.admin/css/H-ui.admin.css" />
    <link rel="stylesheet" type="text/css" href="/shopping/public/static/admin_index/lib/Hui-iconfont/1.0.8/iconfont.css" />
    <link rel="stylesheet" type="text/css" href="/shopping/public/static/admin_index/static/h-ui.admin/skin/default/skin.css" id="skin" />
    <link rel="stylesheet" type="text/css" href="/shopping/public/static/admin_index/static/h-ui.admin/css/style.css" />
    <!--[if IE 6]>
        ...
        <dl id="menu-product">
            ...
            <dd>
                <ul>
                    ...
                    <li><a href="<?php echo url('order/list1'); ?>" title="订单">订单管理</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-comments">
...
<!--_footer 作为公共模版分离出去-->
<script type="text/javascript" src="/shopping/public/static/admin_index/lib/jquery/1.9.1/jquery.min.js"></script>
<script type="text/javascript" src="/shopping/public/static/admin_index/lib/layer/2.4/layer.js"></script>
<script type="text/javascript" src="/shopping/public/static/admin_index/static/h-ui/js/H-ui.js"></script>
<script type="text/javascript" src="/shopping/public/static/admin_index/static/h-ui.admin/js/H-ui.admin.page.js"></script>
<!--/_footer /作为公共模版分离出去-->
<!--请在下方写此页面业务相关的脚本-->
