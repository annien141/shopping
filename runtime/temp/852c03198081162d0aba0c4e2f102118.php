<?php /*a:1:{s:79:"D:\01\phpstudy\PHPTutorial\WWW\shopping\application\admin\view\index\index.html";i:1561089684;}*/ ?>
    ...
    <div class="menu">
        ...
        <ul>
            ...
            <li>
                ...
                <dl>
                    <dt><a href="javascript:void(0)" onclick="menuCAClick('tgls/agent/agent_add.html',this, 'page10022')">添加代理商</a></dt>
                    <dt><a href="javascript:void(0)" onclick="menuCAClick('tgls/agent/agent_list.html',this, 'page10023')">代理商列表</a></dt>
                </dl>
            </li>
            <li>
                ...
                <dl>
                    ...
                    <dt><a href="javascript:void(0)" onclick="menuCAClick('tgls/goodsManage/goods_list.html',this, 'page10025')">基本商品库</a></dt>
                    <dt><a href="javascript:void(0)" onclick="menuCAClick('tgls/goodsManage/goods_add.html',this, 'page10026')">添加商品</a></dt>
                </dl>
            </li>
            <li>
                ...
                <dl>
                    <dt><a href="javascript:void(0)" onclick="menuCAClick('tgls/base/base_add.html',this, 'page10027')">表单含编辑器</a></dt>
                    <dt><a href="javascript:void(0)" onclick="menuCAClick('tgls/base/base_list.html',this, 'page10028')">常用列表</a></dt>
            ...
            <li>
                ...
                <dl>
                    ...
                    <dt><a href="javascript:void(0)" onclick="menuCAClick('tgls/into_out/outPrintData.html',this, 'page10038')">打印单打印模版</a></dt>
                </dl>
            </li>
        </ul>
    </div>
