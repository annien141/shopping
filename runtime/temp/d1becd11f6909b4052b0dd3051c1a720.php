...
<head>
    ...
    <title>登录</title>
    <link rel="stylesheet" href="/shopping/public/static/user_login/css/normalize.css">
    <link rel="stylesheet" href="/shopping/public/static/user_login/css/login.css">
    <link rel="stylesheet" href="/shopping/public/static/user_login/css/sign-up-login.css">
    <link rel="stylesheet" type="text/css" href="http://cdn.bootcss.com/font-awesome/4.6.0/css/font-awesome.min.css">
    <link rel="stylesheet" href="/shopping/public/static/user_login/css/inputEffect.css" />
    <link rel="stylesheet" href="/shopping/public/static/user_login/css/tooltips.css" />
    <link rel="stylesheet" href="/shopping/public/static/user_login/css/spop.min.css" />

    <script src="/shopping/public/static/user_login/js/jquery.min.js"></script>
    <!--<script src="/shopping/public/static/user_login/js/snow.js"></script>-->
    <script src="/shopping/public/static/user_login/js/jquery.pure.tooltips.js"></script>
    <script src="/shopping/public/static/user_login/js/spop.min.js"></script>
    <script>
        (function() {
    ...
    <style type="text/css">
        ...
        body{
            ...
            background-image: url(/shopping/public/static/user_login/images/snow.jpg);
    ...
    <div class="wrapper">
        ...
        <div class="login sign-in-htm">
            <form class="container offset1 loginform">
                ...
                <div class="form-actions">
                    <a tabindex="4" class="btn pull-left btn-link text-muted" onClick="goto_forget1()">忘记密码?</a>
                    <a tabindex="5" class="btn btn-link text-muted" onClick="goto_register1()">注册</a>
        ...
        <div class="login sign-out-htm">
            <form action="#" method="post" class="container offset1 loginform">
                ...
                <div class="form-actions">
                    <a class="btn pull-left btn-link text-muted" onClick="goto_login1()">返回登录</a>
